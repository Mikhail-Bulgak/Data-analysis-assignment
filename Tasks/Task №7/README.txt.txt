...
6. После применения фильтра и/или сортировки необходимо обеспечить возможность выгрузки информации в файл xlsx. Выгружаться должны все строки или только те, которые остались после применения фильтра (предусмотреть возможность выбора «что экспортировать»).
